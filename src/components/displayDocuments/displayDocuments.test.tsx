...
//     expect.assertions(1);
//     render(
//       <MemoryRouter initialEntries={["/tag/trade-trust"]}>
//         <Routes>
...
//     expect.assertions(1);
//     render(
//       <MemoryRouter initialEntries={["/tag/open-certs"]}>
//         <Routes>
...
//     expect.assertions(1);
//     render(
//       <MemoryRouter initialEntries={["/tag/health-certs"]}>
//         <Routes>
...
//     expect.assertions(1);
//     render(
//       <MemoryRouter initialEntries={["/tag/nyc-certs"]}>
//         <Routes>
...
//     expect.assertions(1);
//     render(
//       <MemoryRouter initialEntries={["/tag/licence"]}>
//         <Routes>
...
//     expect.assertions(1);
//     render(
//       <MemoryRouter initialEntries={["/tag/trade-trust?version=3"]}>
//         <Routes>
//           <Route path={`/`}>
//             <DisplayDocuments documents={sampleDocuments} />
//           </Route>
